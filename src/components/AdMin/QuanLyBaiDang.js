...
function QuanLyBaiDang() {
    ...
    async function get_User() {
        const urlUser = `http://phatnguyen.nikinpham.com/be/public/index.php/api/phongtro/selectall`;
                        ...
                        Users.map((item, i) => 
                            <tr key={item.PhongTroID}>
                                ...
                                <td style={{ width: "200px"}}>
                                    ...
                                    <Link to="/admin" onClick={() => deleteBaiDang(item.PhongTroID)} className="delete" ><i style={{ fontSize: "15px" }} className="fa fa-remove">Xoá</i></Link>
                                </td>
                            </tr>
                        )
                    }
    ...
    function deleteBaoCao(PhongtroID) {
        let a = [PhongtroID];
        const url = `http://phatnguyen.nikinpham.com/be/public/index.php/api/baocao/deleteBaoCao/${a}`
            fetch(url, {
                method: 'DELETE'
            }).then((result) => {
    ...
    function deleteBaiDang(PhongtroID) {
        let a = [PhongtroID];
